...
public class aplicacion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        colorPicker.setOnClickListener(v -> {
            ...
            btnProcesar.setVisibility(View.INVISIBLE);
            btnCopear.setVisibility(View.INVISIBLE);
            AmbilWarnaDialog ambilWarnaDialog = new AmbilWarnaDialog(aplicacion.this, defaultColor, new AmbilWarnaDialog.OnAmbilWarnaListener() {
                @Override
        ...
        btnCopear.setOnClickListener(v -> {
            ...
            Toast.makeText(aplicacion.this, "Texto copiado al portapapeles", Toast.LENGTH_SHORT).show();
